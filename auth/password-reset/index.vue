  ...
  <div class="flex flex-col justify-center min-h-screen py-12 bg-gray-50 sm:px-6 lg:px-8">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      <div class="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
        <form @submit.prevent="onSubmit" v-if="!emailSent">
          <div>
            <label
              for="email"
            ...
            <span
              ...
              v-if="form.email.includes('burberry.com')"
            >Please use SSO</span>
          </div>
          ...
          <div class="mt-6">
            <span class="block w-full rounded-md shadow-sm">
              <button
                :disabled="loading || form.email.includes('burberry.com')"
                type="submit"
                ...
                :class="loading || form.email.includes('burberry.com') ? 'cursor-not-allowed bg-gray-700' : 'bg-gray-800'"
