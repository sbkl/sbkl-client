<template>
  <div class="leading-loose text-gray-800">
    <h2 class="font-bold text-3xl text-gray-900 mb-10">Privacy Policy</h2>
    <p>
      Sebastien Koziel built the {{ appName }} app as a Commercial app. This
      SERVICE is provided by Sebastien Koziel and is intended for use as is.
    </p>
    <p>
    ...
    <p>
      ...
      Terms and Conditions, which is accessible at {{ appName }} unless
      otherwise defined in this Privacy Policy.
    </p>
    <p class="text-gray-900 mt-5">
      <strong>Information Collection and Use</strong>
    </p>
    <p>
      For a better experience, while using our Service, I may require you to
      provide us with certain personally identifiable information, including but
      not limited to first name, last name and email. The information that I
    ...
    <p>
      ...
      used to identify you at the moment.
    </p>
    <p class="text-gray-900 mt-5">
    ...
    <p>
      ...
      <a href="mailto: sebastien@sbkl.ltd" class="text-teal-500 underline"
        >sebastien@sbkl.ltd</a
      >
      .
    </p>
  </div>
